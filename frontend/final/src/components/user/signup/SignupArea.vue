  ...
  <div class="">
    ...
    <div class="">
      ...
      <v-form>
          ...
          <v-text-field name="email" label="이메일주소" id="email" v-model="email" type="email" required color="#48B9A8"><v-btn id="mainBtn" slot="append" style="margin:5px; width:120px;">인증번호 전송</v-btn></v-text-field>
