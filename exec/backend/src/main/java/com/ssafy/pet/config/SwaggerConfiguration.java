...
//   http://localhost:8888/pet/swagger-ui.html

   private String version = "V1";
   private String title = "PET API " + version;
   ...
   public Docket api() {
      ...
      return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(version).select()
               .apis(RequestHandlerSelectors.basePackage("com.ssafy.pet.controller"))
...
//      return regex("/admin/.*");
   ...
   private ApiInfo apiInfo() {
      return new ApiInfoBuilder().title(title)
            .description("<h3>PET API Reference for Developers</h3><br>") 
            .version("1.0").build();
